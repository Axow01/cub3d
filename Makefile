...
SRC = src/main.c src/map.c src/minimap.c src/movement.c src/parse_headers.c src/parse_map.c src/parsing.c src/raycaster.c src/render_minimap.c src/draw.c
